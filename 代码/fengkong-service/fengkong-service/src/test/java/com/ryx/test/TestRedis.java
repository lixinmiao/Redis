...
import com.ryx.TopicMessageListener;
import com.ryx.global.util.RedisUtils;
...
public class TestRedis {
	...
	public static void main(String[] args) throws Exception {
		...
		TopicMessageListener topicMessageListener=(TopicMessageListener) context.getBean("topicMessageListener");
		...
		redisUtil.hmset("15905197637", map,1000);
		
		redisUtil.del("15532002723");
...
*/		
		...
		map.put("name".getBytes(), "hefei".getBytes());
		redisUtil.hmset("18651867230", map);*/
	}
